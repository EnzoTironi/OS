...
Cleanup is profound. You do not leave dest-wrong teaching beside dest-true teaching. You do not dest-amend, add a leftover banner, or keep a catalog id, ADR sentence, or demo path because it was historical V1. When a file is in your hand, you finish every leftover dest-wrong sentence in that file. You migrate then delete. A leftover sentence is a bug, not a follow-up.
