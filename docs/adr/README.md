...
When a later ADR narrows an earlier one, the later ADR controls. In particular ADR-0016 promotes DataFusion from an Architecture-v0 candidate to the selected V1 read/compute engine, and ADR-0021 strengthens conformance into a no-stub production E2E release law.
