...
- [ADR-0025 — Action preview_hash is SHA-256 of RFC 8785 JCS](0025-action-preview-hash-binding.md)
- [ADR-0026 — Three drawers stay isolated at runtime](0026-three-drawer-isolation.md)
- [ADR-0027 — Production invariants expose JCS mismatch and admit latency](0027-production-invariants-and-telemetry.md)
