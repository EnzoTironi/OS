...
const outputDirectory =
  ...
  path.join("e2e", "company-bootstrap-shadow", ".generated");
const actionId = "commercial.changeCommitment";
const activationActionId = "zoen.definition.activate";
const definitionIds = ["bootstrap.tenant.sample.enterprise.mapping"];
const resourceId = "product.item.1";
