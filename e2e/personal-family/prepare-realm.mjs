...
const outputDirectory =
  ...
  path.join("e2e", "personal-family", ".generated");
...
const realm = {
  ...
  clients: [
    ...
    // Bound clients whose JWT tenant hint matches Family/Org membership tenants.
    // Membership principal still wins over the phone-shaped JWT principal.
    confidentialClient({
      actorId: "actor.bound.family.viewer",
      clientId: "bound-family-viewer",
      principalId: "principal.phone.family.viewer",
      tenantId: "tenant.family.1",
      workloadId: "workload.bound.family.viewer",
    }),
    confidentialClient({
      actorId: "actor.bound.family.approver",
      clientId: "bound-family-approver",
      principalId: "principal.phone.family.approver",
      tenantId: "tenant.family.1",
      workloadId: "workload.bound.family.approver",
    }),
    confidentialClient({
      actorId: "actor.bound.org.member",
      clientId: "bound-org-member",
      principalId: "principal.phone.org.member",
      tenantId: "tenant.org.a",
      workloadId: "workload.bound.org.member",
    }),
  ],
  enabled: true,
  realm: "zoen",
