...
cursor_digest!(
    ...
    ///
    /// W2-06's cursor substrate accepts this typed value but does not mint it. Until W2-05
    /// supplies trusted per-verb authority, callers authenticate its explicit absence.
